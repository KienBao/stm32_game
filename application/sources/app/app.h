...
#define AC_LIFE_TASK_TIMER_GAME_LIFE_INTERVAL		(2000)
...
#define AC_DISPLAY_SHOW_HAPPY_BIRTHDAY_SNOW_MOVING_UPDATE_INTERAL	(150)
#define AC_DISPLAY_SHOW_HAPPY_BIRTHDAY_SLEEP_INTERVAL				(15000)

#define AC_STAR_NEWGAME_UPDATE_INTERAL				(100)
#define AC_DISPLAY_GAME_MOVING_UPDATE_INTERAL	(150)
...
enum {
	...
	AC_DISPLAY_SHOW_HAPPY_BIRTHDAY_SNOW_MOVING_UPDATE,
	AC_DISPLAY_SHOW_HAPPY_BIRTHDAY_SLEEP,
	AC_DISPLAY_SHOW_GAME_CONCA_MOVING_UPDATE,

	AC_STAR_NEWGAME_UPDATE,
...
/* define signal */
enum {
	AC_HELLO_PRINT_1 = AK_USER_DEFINE_SIG,
};

enum {
	AC_GAME_PUSH = AK_USER_DEFINE_SIG,
};

enum {
	AC_RESET_NEWGAME = AK_USER_DEFINE_SIG,
};

enum {
	AC_EARTH_MOVE = AK_USER_DEFINE_SIG,
	AC_STAR_MOVE,
};
